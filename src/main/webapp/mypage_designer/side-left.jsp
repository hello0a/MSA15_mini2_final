...
<div class="container">
	...
	<nav class="mypage-index">
		...
		<a href="${root}/mypage_designer/reserve.jsp" class="list">예약 관리</a>
		<a href="${root}/mypage_designer/reserve_detail.jsp" class="list">상세보기</a>
		<a href="${root}/mypage_designer/review.jsp" class="list">고객 후기 관리</a>
